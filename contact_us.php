...
<head>
    ...
    <title>Homeland Foundation - contact us</title>
...
<body onload="displayHelp()">
        ...
        <header id="mainHeader">
            ...
            <ul>
                    ...
                    <li class="active"><a href="contact_us.php" title="Contact us">Contact</a></li>
                </ul>
            </nav>
        ...
        <section id="ourExistence">
            ...
            <div class="cont">
                <div class="contactInfo">
                    <p>We are here to serve you.<br>
                    For more info about our services, or to report an incident you can contact us at:<br><br>
                    <strong>Our head office:</strong> 360 Housing Complex Road  Ekpan, Effurun, Delta state<br><br>
                    <strong>Call us on:</strong> 09023140300, 08157985866<br><br>
                    <strong>Email:</strong> info@homelandfoundation.org, contact@homelandfoundation.org<br><br>
                    Please fill the form below to know more or make a complaint.
                    </p>
                    <form method="post" action="contact.php" id="contactForm">              <fieldset>
                            <legend>Drop your message</legend>
                            <label for="fullName">Full Name</label><br>
                            <input type="text" id="fullName" name="name" placeholder="John Smith" required><br><br>
                            <label for="email">Email</label><br>
                            <input type="email" id="email" name="email" placeholder="mail@example.com"><br><br>
                            <label for="phoneNumber">Phone Number</label><br>
                            <input type="tel" id="phoneNumber" name="phone" placeholder="08123456789" required><br><br>
                            <label for="serviceOffer">Service</label><br>
                            <select name="service" required>
                                <option value="" selected>What is your request</option>
                                <option vlaue="Cake">General Complaint</option>
                                <option vlaue="Events">Book an appointment</option>
                                <option vlaue="Beddings">Report an Incident</option>
                            </select><br><br>
                            <textarea name="content" placeholder="Please tell us how we can help you" cols="50" rows="5" required></textarea><br><br>
                            <input type="submit" value="Send" id="contactSubmit">
                        </fieldset>
                    </form>
                </div>
                <img src="images/community_police.jpeg" alt="contact community police">
            </div>
        </section>
    </main>
    <footer>
