...
<head>
    ...
    <meta name="keywords" content="vigilante, cultism, homelnad, homeland foundation, homeland security, community policing, security, police, secure, community, crime, fight crime, rape, cultism, corruption, kidnapping">
    <title>Homeland Foundation - Edo vigilante declares war on cult gang in Benin city</title>
...
<body onload="displayHelp()">
        ...
        <section id="aboutBanner">
            <div class="bannerImg">
                <img src="images/vigilante_declare_war.webp" alt="police arrests 3 brothers for kidnapping">
            </div>
        ...
        <section id="ourExistence">
            <div class="blog_article">
                <article>
                    <h3>Fire For Fire: Edo Vigilantes Declares War On Cult Gangs As Killings Reignites In Benin City.</h3>
                    <div class="details">
                        <span class="category" style="color:#fff; background-color:red">Cultism</span>
                        <span><strong>Pubished: </strong>24<sup>th</sup> January, 2021</span>
                    </div>
                    <hr>
                    <p>“If you be Aye , if you be Eiye , you be buccaneer or Manphite or whatever injews and you dey roll abeg enter house.”<br><br>

                    Edo State Vigilante network in Benin City has declared war on all cult activities as cult gang war reignites in Benin City.<br><br>

                    In the last 24 hrs, no fewer than 5 deaths have been recorded in Benin City as a result from bloody clashes between the Black Axe and Supreme Eiye Confraternity, in what seems to be a declaration of enough is enough the state vigilantes has declared war on all clandestine activities by cult gangs in Benin City.<br>

                    <img src="images/homeland_5.jpg" alt="edo vigilante declare war against cultist"><br>

                The fearless vigilantes groups have taken it upon themselves to fish out these dastardly criminals operating under the canopy of a gang war in unleashing mayhem on the good citizens of the State.<br>

                As at the time of filing this report the vigilante group has recorded some success as no fewer than 6 cult boys have been apprehended Saturday evening in preparation of an attack on rival gang members.<br><br>

                According to the vigilante groups, if you be  Aye , if you be Eiye, you be buccaneer or Manphite and you dey roll enter house. Any cultist found with ammunitions would be treated like a terrorist.<br>

                Benin City is currently at siege as cults activities have reared its ugly head once again.<br>

                The introduction of community policing via local vigilantes has recently restored some sanity only for this unfortunate incidence to rear its ugly head.<br><br>

                As a matter of observation, the state vigilante has recorded huge success in suppressing crime in Benin City these past few weeks.

                We only hope the State Government should encourage their selfless efforts.<br>

                Osigwe Omo-Ikirodah writes in from Benin City.<br>
                <em>Source iReporteronline.</em> <br><br>
                If you find any suspicious activities, quickly report by clicking
                <a href="javascript:void(0);" onclick="displayComplainBox()"> Here</a><br>
                    Security for all<br><br></p>
                </article>
                <aside>
                    <h3>Related Posts</h3>
                    <div class="aside_articles">
                        ...
                        <figure>
                            ...
                            <img src="images/police-arrest-3-brothers-for-kidnap.jpg" alt="hazards">
                            <figcaption>Police arrest 3 Brothers for kidnapping</figcaption></a>
                        </figure>
                    </div>
                </aside>
            </div>
