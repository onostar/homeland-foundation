...
<head>
    ...
    <title>Homeland Foundation - Events videos</title>
...
<body onload="displayHelp()">
                ...
                <ul>
                    ...
                    <li><a href="javascript:void(0);" title="All our work">Events<i class="fas fa-sort-down"></i></a>
                        <ul>
                            ...
                            <li class="active"><a href="event_media.php" title="Recent videos">Event media</a></li>
                        </ul>
                    </li>
        ...
        <section id="ourExistence">
            <h2>Tips and events media</h2>
            <hr size="5">
            <p class="peek">Have a glance at our actvities</p>
            <div class="galleria">
                <figure class="videos">
                    <video controls>
                        <source src="images/edo_vigilante.mp4" type="video/mp4">
                    </video>
                    <figcaption>Edo vigilante on training</figcaption>
                </figure>
                <figure class="videos">
                    <video controls>
                        <source src="images/event_media1.mp4" type="video/mp4">
                    </video>
                    <figcaption>Observing proper hand washing routine</figcaption>
                </figure>
                <figure class="videos">
                    <video controls>    
                        <source src="images/event_media2.mp4" type="video/mp4">
                    </video>
                    <figcaption>Warining against highway robbers</figcaption>
